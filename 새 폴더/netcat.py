...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        ...
        netcat.py -t 192.168.1.108 -p 5555 -l -u=myfile.txt      # file upload
        netcat.py -t 192.168.1.108 -p 5555 -l -e="cat /etc/passwd" # exec command
        echo 'Hello' | ./netcat.py -t 192.168.1.108 -p 135       # send to port
    ...
    parser.add_argument('-u', '--upload', help='upload file to target')
